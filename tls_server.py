...
if not os.path.exists(CERT_DIR):
    print(f"Certificate directory '{CERT_DIR}' does not exist.")
if not os.path.isfile(SERVER_CERT):
    print(f"Server certificate '{SERVER_CERT}' does not exist.")
if not os.path.isfile(SERVER_KEY):
    print(f"Server key '{SERVER_KEY}' does not exist.")
if not os.path.isfile(PEER_CERT):
    print(f"Peer certificate '{PEER_CERT}' does not exist.")
...
def handle_client(client_socket, client_address):
    print(f"handeling client {client_address}")
    try:
